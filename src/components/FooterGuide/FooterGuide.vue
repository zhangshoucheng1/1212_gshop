<template>
    <footer class="footer_guide">
      ...
      <span class="item_icon">
        <i class="iconfont iconlmmkkmwaimai"></i>
      </span>
            <span>外卖</span>
        </a>
      ...
      <span class="item_icon">
        <i class="iconfont icondd_active"></i>
      </span>
            <span>订单</span>
        </a>
        <a href="javascript:;" class="guide_item" :class="{on: '/profile'===$route.path}" @click="$router.replace('/profile')">
      <span class="item_icon">
        <i class="iconfont icongerenzhongxinwoderenwubiaozhuntoumianxing"></i>
      </span>
            <span>我的</span>
        </a>
    </footer>
